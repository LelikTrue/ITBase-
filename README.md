...
- Исправлены формы добавления и редактирования активов
- Улучшена валидация данных с безопасной обработкой пустых значений
- Добавлена функция автозаполнения форм тестовыми данными
- Исправлена структура HTML и устранены дублирующиеся поля
- Оптимизирован пользовательский интерфейс с вкладочной навигацией
- Улучшена обработка фильтров журнала аудита для предотвращения ошибок 422 (Unprocessable Entity)
