...
def upgrade() -> None:
    ...
    op.alter_column(
        'network_settings', 'is_online', existing_type=sa.BOOLEAN(), nullable=False
    )
    op.alter_column(
        'network_settings', 'is_tagged', existing_type=sa.BOOLEAN(), nullable=False
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column(
        'network_settings', 'is_tagged', existing_type=sa.BOOLEAN(), nullable=True
    )
    op.alter_column(
        'network_settings', 'is_online', existing_type=sa.BOOLEAN(), nullable=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            'id',
            sa.INTEGER(),
            server_default=sa.text("nextval('\"ActionLog_id_seq\"'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column(
