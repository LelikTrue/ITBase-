...
class SupplierService(
    ...
    BaseService[Supplier, SupplierCreate, SupplierUpdate],
):
    """
    ...
    async def create(
        self, db: AsyncSession, obj_in: SupplierCreate, user_id: int
    ) -> Supplier:
        """
    ...
    async def update(
        self, db: AsyncSession, obj_id: int, obj_in: SupplierUpdate, user_id: int
    ) -> Supplier | None:
        """
