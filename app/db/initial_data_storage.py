...
ASSET_TYPES = [
    {
        "name": "Компьютер",
        "prefix": "PC",
        "description": "Настольные и портативные компьютеры",
    },
    ...
    },
    {
        "name": "Периферия",
        "prefix": "PERI",
        "description": "Клавиатуры, мыши, веб-камеры",
    },
    {
        "name": "Аудио/Видео",
        "prefix": "AV",
        "description": "Колонки, наушники, проекторы",
    },
]
...
def get_device_models(manufacturers_map: dict, asset_types_map: dict) -> list[dict]:
    ...
    return [
        {
            "name": "OptiPlex 7090",
            "manufacturer_id": manufacturers_map.get("Dell"),
            "asset_type_id": asset_types_map.get("Компьютер"),
        },
        {
            "name": "ThinkPad T14",
            "manufacturer_id": manufacturers_map.get("Lenovo"),
            "asset_type_id": asset_types_map.get("Компьютер"),
        },
        {
            "name": "EliteBook 850",
            "manufacturer_id": manufacturers_map.get("HP"),
            "asset_type_id": asset_types_map.get("Компьютер"),
        },
        {
            "name": "UltraSharp U2419H",
            "manufacturer_id": manufacturers_map.get("Dell"),
            "asset_type_id": asset_types_map.get("Монитор"),
        },
        {
            "name": "LaserJet Pro M404n",
            "manufacturer_id": manufacturers_map.get("HP"),
            "asset_type_id": asset_types_map.get("Принтер"),
        },
    ]
