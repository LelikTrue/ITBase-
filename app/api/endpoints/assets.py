...
from app.services.exceptions import DeviceNotFoundException, DuplicateDeviceError, DeletionError, NotFoundError
...
async def delete_asset(
    ...
    try:
        ...
        flash(request, f"Ошибка: Актив для удаления не найден.", "danger")
        ...
        flash(request, f"Произошла непредвиденная ошибка при удалении.", "danger")
