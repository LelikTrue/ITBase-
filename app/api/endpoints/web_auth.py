...
async def register_user(
    ...
    flash(request, f'Добро пожаловать, {new_user.full_name or new_user.email}! Регистрация прошла успешно.', category='success')
    return RedirectResponse(url='/dashboard', status_code=303)
...
async def web_login(
    ...
    flash(request, f'Добро пожаловать, {user.full_name or user.email}!', category='success')
    return RedirectResponse(url='/dashboard', status_code=303)
