...
def create_app() -> FastAPI:
    ...
    async def root_redirect(request: Request):
        ...
        try:
            ...
            logger.critical(f"Не удалось найти URL для 'dashboard'. Убедитесь, что эндпоинт с name='dashboard' существует. Ошибка: {e}")
            return JSONResponse(status_code=500, content={"detail": "Ошибка конфигурации сервера: не найден маршрут для 'dashboard'."})
