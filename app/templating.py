...
def format_diff(value):
    ...
    for field in sorted_fields:
        ...
        if field in ['Дата покупки', 'Дата окончания гарантии'] and old_val and old_val != '<em>пусто</em>':
            try:
        ...
        if field in ['Дата покупки', 'Дата окончания гарантии'] and new_val and new_val != '<em>пусто</em>':
            try:
